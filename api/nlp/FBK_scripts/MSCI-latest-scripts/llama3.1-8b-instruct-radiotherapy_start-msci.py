...
#    return "radiotherapy (conventional)" in annotation.lower()
    return "intention started" in annotation.lower() and "radiotherapy" in annotation.lower()
...
def generate_prompt_template(few_shot_examples, static_samples):
    return f"""Task: You are an expert medical annotator specializing in oncology pathology. Your task is to extract extract radiotherapy details from the provided medical note and output it in a precise, templated format.
