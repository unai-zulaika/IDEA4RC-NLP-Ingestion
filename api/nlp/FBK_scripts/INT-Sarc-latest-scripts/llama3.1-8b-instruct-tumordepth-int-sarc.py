...
def filter_annotations(example):
    ...
    return "tumor depth" in annotation.lower()
...
def generate_prompt_template(few_shot_examples):
    return f"""You are a clinical information extraction assistant specialized in oncology pathology and radiology reports.
