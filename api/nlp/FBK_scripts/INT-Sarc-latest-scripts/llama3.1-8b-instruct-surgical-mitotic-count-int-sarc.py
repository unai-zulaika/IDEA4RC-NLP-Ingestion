...
df1 = pd.read_csv('Sarc_data-phase2.csv')
...
def filter_annotations(example):
    ...
    return "surgical specimen mitotic count" in annotation.lower()
...
print('TEST: ', test_dataset["note_original_text"][1])
print(len(test_dataset["note_original_text"][1].split()))
...
def generate_prompt_template(few_shot_examples):
    return f"""You are a clinical information extraction assistant specialized in oncopathology.  
